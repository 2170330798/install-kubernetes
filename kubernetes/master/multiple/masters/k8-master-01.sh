...
sudo sed -i 's@kubernetesVersion: '${VERSION}'@kubernetesVersion: '${VERSION}'\ncontrolPlaneEndpoint: '${APISERVER_ADDRESSES}:${APISERVER_DEST_PORT}'@g' /etc/kubernetes/kubeadm-init.yaml
